...
- e3e8417: Add removeEventFromCollections endpoint with optimistic isSaved cache toggle
...
- eb3399d: Add removeEventFromCollections endpoint and hook
  - Add `removeEvent(eventId)` method to CollectionsClient (DELETE /api/v1/collections/events/{event-id})
...
- 28d7016: Event ids on create collection should be optional
